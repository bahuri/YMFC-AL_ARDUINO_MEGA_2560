...
////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  calculate_pid(); 
 // Serial2.println(pid_output_roll);
 // Serial2.println(pid_output_yaw);
  //Serial2.println(pid_output_pitch);//PID inputs are known. So we can calculate the pid output.
//Serial2.write(loop_timer);
  ...
  PORTF |= B11110000;                                                       //Set digital outputs 4,5,6 and 7 high.
  ...
  while(PORTF >= 16){                                                       //Stay in this loop until output 4,5,6 and 7 are low.
    esc_loop_timer = micros();                                              //Read the current time.
    if(timer_channel_1 <= esc_loop_timer)PORTF &= B11101111;                //Set digital output 4 to low if the time is expired.
    if(timer_channel_2 <= esc_loop_timer)PORTF &= B11011111;                //Set digital output 5 to low if the time is expired.
    if(timer_channel_3 <= esc_loop_timer)PORTF &= B10111111;                //Set digital output 6 to low if the time is expired.
    if(timer_channel_4 <= esc_loop_timer)PORTF &= B01111111;                //Set digital output 7 to low if the time is expired.
  }
}
...
ISR(PCINT2_vect){
  ...
  //Channel 2=========================================
  if(PINK & B00000010 ){                                                    //Is input 9 high?
  ...
  //Channel 3=========================================
  if(PINK & B00000100 ){                                                    //Is input 10 high?
  ...
  //Channel 4=========================================
  if(PINK & B00001000 ){                                                    //Is input 11 high?
